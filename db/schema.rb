...
ActiveRecord::Schema.define(version: 20180531173442) do
  ...
  create_table "article_authorities", force: :cascade do |t|
    ...
    t.index ["article_id"], name: "index_article_authorities_on_article_id"
    t.index ["authority_id"], name: "index_article_authorities_on_authority_id"
  end
